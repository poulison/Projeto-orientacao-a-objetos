...
public class ControllerScompra {
    Contas s;
    private SenhaCompra view;
    private Investidor investidor ;

    public ControllerScompra(SenhaCompra view, Investidor investidor, Contas s) {
        this.view = view;
        this.investidor = investidor;
        this.s = s;
    }
    public SenhaCompra getView() {
        return view;
    }

    public void setView(SenhaCompra view) {
        this.view = view;
    }
       ...
       Investidor investidor = new Investidor(null, s.getLblcpf().getText(),
        ...
        try{
            ...
            if(res.next()){
                ...
                Comprar c = new Comprar(new Investidor(carteira, nome, CPF, senha));
                c.setVisible(true);
